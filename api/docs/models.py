...
class Docs(TypesBaseModel):
    ...
    ruc = models.CharField(verbose_name='Ruc',help_text='Ruc del receptor del Documento',max_length=13,blank=True,null=True)
...
class Agreements(TypesBaseModel):
    ...
    contact = models.CharField(verbose_name='Contacto',help_text='Contacto de la Empresa',max_length=100,blank=True,null=True)
    ...
    valueunit = models.DecimalField(max_digits=10,decimal_places=2,help_text='Acuerdo de Valor de servicio',verbose_name='Valor Unitario',blank=False,null=False)
